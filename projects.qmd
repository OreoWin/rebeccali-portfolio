...
[View PDF](files/xgb_vsm.pdf){.btn .btn-primary target="_blank"}
...
[View PDF](files/wildfair.pdf){.btn .btn-primary target="_blank"}
...
[View PDF](files/Portfolio%20Construction%20and%20Risk%20Analysis.pdf){.btn .btn-primary target="_blank"}
